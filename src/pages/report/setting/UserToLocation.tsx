...
const UserToLocation: FC<UserToLocationProps> = (props) => {
    ...
    const generateReport = () => {
        ...
        RequestPDF({
            url: UrlEnum.ReportUserToLocation,
            method: "GET",
            params: params
        })
            .then((response: any) => {
    ...
    return (
        <Layout>
            <div style={{
                ...
                <Title level={2} style={{margin: "0px"}}>Сотрудники по кабинетам</Title>
            </div>
